...
Pod::Spec.new do |s|
  ...
  #pod详细描述
  s.description  = <<-DESC
                    this is Test4Project develop by xueersi Base component library team
                   DESC
  #项目主页地址
  s.homepage     = "https://github.com/hu646641434/XES_TEST4"
  ...
  #库索引地址
  s.source       = { :git => "https://github.com/hu646641434/XES_TEST4.git", :tag => s.version.to_s }

  #需要包含的源文件
  s.source_files  = "Test4Project/*.{h,m}"
  #需要移除的文件
